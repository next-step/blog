...
### ✅ 2. 배포한 블로그 페이지 링크를 fork한 본인의 저장소의 README에 작성한다. 
...
### ✅ 4. 온라인 세션 시간에 서로의 글을 읽고 간단한 피드백 및 리뷰를 남기고 회고의 시간을 가진다. 
...
- [20210419, 리액트에서 컴포넌트를 만드는 방법과 종류](https://velog.io/@younoah/React-component)
